...
| [User Acceptance Testing](uat.md) | A checklist for confirming Revoice does what it claims on your hardware, and how to report what doesn't. Includes the known faults not worth re-filing. |
...
- [rooting.md](rooting.md) — what a device needs before Revoice can use it.
  The exploit itself is R0rt1z2's work on XDA Forums and that thread is canon;
  this covers where Revoice picks up, and what the wizard does for you.
